                ...
                <div class="modal-body">
                    <div class="card-body m-0 p-0">
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control" name="" id="" placeholder="Huling Pangalan" required />
                            <input type="text" class="form-control col-4" name="" id="" placeholder="Buong Panagalan" required />
                            <input type="text" class="form-control col-4" name="" id="" placeholder="Gitnang Pangalan" required />
                        </div>
